...
function messageVisible(message,user){return Boolean(user&& (user.all||message.fromUsername===user.username||message.toUsername===user.username||message.toDepartment===user.department||message.toDepartment==="Todos"))}
